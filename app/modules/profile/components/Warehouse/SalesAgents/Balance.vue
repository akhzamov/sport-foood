...
<template>
  <div class="w-full h-max flex flex-col mt-5">
    <span class="w-full h-[2px] rounded bg-gray-15 flex"></span>
    <h3 class="text-14-semi text-gray-90 mt-5">
      Остатки у торговых агентах
    </h3>
  </div>
  <template v-if="warehouseStore.salesAgentLeft != null">
    <div
      class="flex flex-col items-start w-full h-full border border-gray-40 bg-gray-15 rounded-lg mt-3"
          ...
          <table class="w-full text-sm table-fixed">
            <thead class="flex">
              <tr class="w-full flex">
                <th
                  scope="col"
                  class="min-w-[160px] max-w-[160px] w-full h-[40px] flex items-center justify-center px-2 bg-dark-charcoal border-b border-x border-gray-15"
                >
                  <p class="text-12-semi text-white">Торговые Агенты</p>
                </th>
                <th
                  scope="col"
                  class="flex-grow min-w-[170px] w-full h-[40px] flex items-center justify-center px-2 bg-dark-charcoal border-b border-r border-gray-15"
            ...
            <tbody class="w-full bg-transparent rounded-b-lg flex flex-col">
              ...
              >
                <th
                  scope="col"
                  class="min-w-[160px] max-w-[160px] w-full h-max flex items-center justify-start pl-2 border-b border-r border-dark-charcoal"
                >
                  <div
                  ...
                  >
                    ...
                    <div
                      class="w-full h-max flex flex-col items-start justify-center bg-dark-charcoal p-1 rounded mt-1"
                    >
                      <p
                        class="w-full h-4 flex items-center justify-start bg-green-25 rounded-t-[4px] rounded-b-sm text-8-ext text-gray-90 px-[2px]"
                      >
                        Остатки на руках
                      </p>
                      <div
                        class="w-full h-max flex flex-col gap-1 bg-gray-15 rounded-t-sm rounded-b-[2px] p-[2px] mt-1"
                      >
                        <template
                        ...
                        >
                          <p
                            ...
                            class="w-full h-4 flex items-center justify-between border-b border-dotted border-gray-90 text-gray-90 p-0"
                          >
                            <template
                        ...
                        <p
                          v-else
                          class="w-full h-4 flex items-center justify-between border-b border-dotted border-gray-90 text-gray-90"
                        >
                ...
                <th
                  scope="col"
                  class="flex-grow min-w-[170px] w-full h-auto flex items-start justify-center p-1 border-b border-r border-dark-charcoal"
                  v-for="(district, districtKey) in agent.districts"
                >
                  <div
                    class="w-full h-max flex flex-col gap-1 bg-dark-charcoal rounded p-1"
                  >
                    <template
                      v-if="
