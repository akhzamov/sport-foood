...
<template>
  <div class="flex flex-col w-full h-[360px] bg-dark-gunmental">
    <div
      class="w-full h-[20px] flex items-center px-[20px] bg-dark-charcoal"
    >
      <p class="flex-grow text-10-reg text-white">Торговые площадки</p>
      <p class="w-[80px] text-10-ext text-gray-75 text-end">Вес</p>
      <p class="w-[80px] ml-3 text-10-ext text-gray-75 text-end">Сумма</p>
    </div>
    <div
    ...
    >
      ...
      >
        <div
          :class="[key % 2 == 0 ? 'bg-dark-charcoal' : '']"
        ...
        >
          <div class="flex-grow flex items-center z-[1]">
            <span class="w-4 h-4 text-center text-12-semi text-gray-40">
              {{ item.id }}
            </span>
            <img
              :src="imgPath"
            ...
            />
            <span class="text-10-semi text-gray-90 ml-1">
              {{ item.name }}
            </span>
          </div>
          <div class="w-[80px] flex items-center justify-end z-[1]">
            <span class="text-10-semi text-gray-75">
          ...
          <div
            ...
            class="w-[155px] h-max absolute top-[50%] left-[35%] z-[5] translate-y-[-50%] flex flex-col items-center justify-center gap-1 p-3 bg-dark-gunmental rounded-lg border border-gray-15"
          >
            <div class="w-full flex items-center justify-between">
              <span class="text-8-reg text-gray-90">Продукт</span>
              <span class="text-[7px] font-extralight text-white">
                Остаток
              </span>
            </div>
            <div class="w-full h-[1px] block bg-dark-charcoal my-2"></div>
            <div
