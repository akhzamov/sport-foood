...
import type { ILogisticsCity } from "../../types/Logistics/logisticsDatat.type";
...
const addCityInTable = (cityId: string) => {
  adminLogisticsStore.citiesAddCityModal.find((item: any) => {
    if (item.id == cityId) {
      tableCity.value.push(item);
    }
  });
};
...
<template>
  <TransitionGroup name="alert">
    <LogisticsAddCity
      ...
      :cities="adminLogisticsStore.citiesAddCityModal"
