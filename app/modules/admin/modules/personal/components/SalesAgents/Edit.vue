...
<template>
  ...
  >
    ...
    <div class="w-full flex flex-col items-start mt-3">
      ...
      <div
        class="w-full flex flex-col items-start gap-1 border border-gray-15 p-2 rounded-lg"
      >
        <div class="w-full flex items-center justify-start gap-1">
          <p class="text-14-reg text-gray-40">1</p>
          <div
            class="w-full h-[30px] flex items-center justify-between px-2 rounded-md bg-gray-15"
          >
    ...
    ></div>
    <div
      class="w-full flex flex-col rounded-md border border-gray-15 bg-gray-15 mt-3"
    >
      <div
      ...
      <div class="w-full h-max flex flex-col p-2">
        <div class="w-full h-max flex flex-col px-2 py-1 bg-gray-15 rounded">
          ...
          >
            ...
            <p
              class="w-[140px] h-full pr-[12px] text-end text-14-reg text-gray-90"
            >
              430 000
            </p>
          ...
          <div class="w-full flex flex-col gap-1">
            ...
            >
              <p class="flex-grow text-start text-14-reg text-gray-75">
                Протеин
              </p>
