      ...
      <div class="w-full h-full flex-grow flex items-center justify-start">
        <div class="w-auto h-full flex items-center justify-start">
          ...
          <div
            class="w-max h-[30px] px-3 flex items-center justify-center border-r border-gray-15-color cursor-pointer"
          >
            <IconSettings class="w-[30px] h-[30px] text-gray-40-color" />
          </div>
          <div
            @click="paymentStore.filterShow = true"
            class="w-max h-[30px] px-3 flex items-center justify-center border-r border-gray-15-color cursor-pointer"
          >
            <IconFilters class="w-[30px] h-[30px] text-gray-40-color" />
          </div>
        </div>
      </div>
    </div>
      ...
      <tbody v-if="paymentStore.payments">
        <template v-for="(request, key) in paymentStore.payments" :key="key">
          ...
          >
            ...
            <th
              class="w-[182px] flex items-center justify-start gap-1 pl-2 text-14-reg text-gray-75-color"
            >
              {{ request.store.name }}
            </th>
            <th
            ...
            <th
              class="w-[148px] flex items-center justify-start pl-2 text-14-reg text-gray-75-color"
            >
              {{ request.city.name ?? "Не выбран" }}
            </th>
            <th
              class="w-[160px] flex items-center justify-start pl-2 text-14-reg text-gray-75-color"
            >
            ...
            <th
              class="w-[106px] flex items-center justify-center text-14-reg text-gray-75-color"
            >
              {{ request.created_at }}
            </th>
            <th
              class="w-[140px] flex items-center justify-start pl-3 text-14-reg text-gray-75-color"
            >
              <span
            ...
            <th
              class="w-[96px] flex items-center justify-start pl-3 text-14-reg text-gray-75-color"
            >
              <span
