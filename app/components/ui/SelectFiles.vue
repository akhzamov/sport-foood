...
<template>
  <div class="flex items-center justify-between">
    ...
    >
      ...
      >
        <IconFileCheck03 class="text-gray-40-color mb-1" />
        <span
          class="w-full text-8-reg text-gray-75-color  text-center whitespace-nowrap overflow-hidden text-ellipsis"
        >
      ...
      >
        <IconFilePlus03 class="text-gray-40-color" />
      </div>
    </div>
  </div>
</template>
