...
<template>
	...
	>
		...
		<div class="inline-flex items-center z-10">
			<div
				class="w-5 h-5 rounded-md flex items-center justify-center transition-colors duration-200 border border-gray-75-color"
				:class="{
					'bg-primary-color ': isChecked,
					'bg-gray-15-color': !isChecked,
				}"
			>
				<IconCheck
					v-if="isChecked"
					class="text-white w-[15px] h-[15px]"
				/>
			</div>
		</div>
	</div>
